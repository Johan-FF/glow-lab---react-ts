...
export const OrderConfirmation: React.FC = () => {
  // Mock order data
  const orderNumber = 'GL-' + Math.random().toString(36).substr(2, 9).toUpperCase();
  ...
  return (
    <div className="container mx-auto px-4 py-16">
      <div className="max-w-2xl mx-auto text-center">
        ...
        {/* Support */}
        <div className="mt-12 p-6 rounded-lg bg-accent/10 border border-accent/15">
