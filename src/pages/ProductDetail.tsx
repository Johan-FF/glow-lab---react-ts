  ...
  const handleAddToCart = () => {
    if (!selectedSize || !selectedColor) {
      toast({
        ...
        description: "Por favor selecciona un tamaño y tono",
        variant: "destructive",
      });
      return;
    }
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div className="space-y-4">
          {/* Main Image */}
          <div className="aspect-[4/5] max-w-md mx-auto bg-muted rounded-xl overflow-hidden">
            <img
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-6">
            {/* Colors */}
            <div>
              <h3 className="font-medium mb-3">Tono: {selectedColor || 'Selecciona'}</h3>
            ...
            {/* Sizes */}
            <div>
              <h3 className="font-medium mb-3">Tamaño: {selectedSize || 'Selecciona'}</h3>
              <div className="flex gap-2 flex-wrap">
      ...
      <div className="mt-16">
        <Tabs defaultValue="description" className="w-full">
          <TabsList className="grid w-full grid-cols-3">
            ...
            <TabsTrigger value="care">Uso</TabsTrigger>
          </TabsList>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-muted-foreground">Vegana y cruelty-free</p>
                </div>
                <div>
                  <p className="font-medium">Acabado</p>
                  <p className="text-muted-foreground">Profesional de larga duración</p>
                </div>
                <div>
                  <p className="font-medium">Ingredientes</p>
                  <p className="text-muted-foreground">Sin parabenos ni sulfatos</p>
                </div>
                <div>
          ...
          <TabsContent value="care" className="mt-6">
            <div className="space-y-4">
              <ul className="space-y-2 text-muted-foreground">
                ...
                <li>• Usar antes de 12 meses tras la apertura</li>
                <li>• Evitar contacto directo con la luz solar</li>
              </ul>
            </div>
          </TabsContent>
        </Tabs>
