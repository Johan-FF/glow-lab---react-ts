...
**Fuente:** validator.w3.org sobre documento servido en `http://localhost:8080/auth` (2026-05-21).  
**Resumen:** 1 error CSS · 1 warning HTML · 0 info HTML en este informe.

**Nota:** Los avisos de `<meta … />` en `index.html` documentados en [home.md](./home.md) aplican a todas las rutas; en esta validación de `/auth` el validador solo reportó el badge Lovable.
